...
import { createPost, deletePost, getLoggedInUserPosts, getPost, getPosts, getUserPosts, updatePost } from "../controllers/postsControllers.js";
...
postsRouter.get('/myposts', Authenticate, getLoggedInUserPosts);
